...
| Phase | Module | Slides |
|-------|--------|--------|
| **3** | [🎓 MLP on MNIST — ReLU & Softmax](phase3_mlp_mnist.html) | 11 slides — Architecture 784→128→64→10, ReLU, Softmax, Accuracy formula, pipeline walkthrough, detective analogy |
